...
import '../../home/views/ticket_view.dart';

class TicketDetailsView extends StatelessWidget {
  final Ticket ticket;
  const TicketDetailsView({required this.ticket, super.key});
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: const TextStyle(
                          ...
                          fontFamily: "Inter",
                          color: Color.fromARGB(255, 179, 141, 16),
                        ),
                      ),
                    ),
                  ],
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      child: Row(
                        children: [
                          Center(
                            child: c.activities[index].activityType == "Pickup"
                                ? const Icon(
                                    Icons.login,
                                    color: Colors.green,
                                  )
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                c.activities[index].activityType ?? "",
                                style: const TextStyle(
                                  fontSize: 15,
                                  fontWeight: FontWeight.normal,
                                  fontFamily: "Inter",
                              ...
                              Text(
                                "${c.activities[index].activityTime} ${c.activities[index].activityDate}",
                                style: const TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.w900,
                                  fontFamily: "Inter",
